...
<html>
  ...
  <body>
    ...
    <div id="page-wrapper">
      <?php includeTitle('Add Teacher'); ?>

      <div class="row">
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              <i class="fa fa-user fa-fw"></i> &nbsp;Add Teacher
            </div>
            <div class="panel-body">
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-4" for="hiredate">Hire Date:</label>
                  <div class="col-sm-offet-1 col-sm-7">
                    <input type="date" class="form-control" id="hiredate" required name="hiredate" >
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-4 col-sm-8">
                    <button type="submit" class="btn btn-default" formmethod="post" formaction="processAddTeacher.php">Add</button>
                  </div>
                </div>
              </form>
            </div>
